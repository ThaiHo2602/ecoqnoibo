                        ...
                        fetch(form.action, {
                            ...
                            .then(function (data) {
                                ...
                                if (!tableBody.querySelector('[data-room-row-id]')) {
                                    tableBody.innerHTML = '<tr data-room-empty-row><td colspan="10"><div class="empty-state my-3">Chưa có phòng nào phù hợp với bộ lọc hiện tại.</div></td></tr>';
                                }
