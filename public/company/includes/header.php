...
$faviconUrl = app_url('assets/images/logo.png');
$employeeAccessUrl = app_url('login');
$employeeAccessLabel = 'Đăng nhập nhân viên';

$navItems = [
    'home' => ['label' => 'Trang chủ', 'url' => base_url('index.php')],
    'about' => ['label' => 'Giới thiệu', 'url' => base_url('gioi-thieu.php')],
    'projects' => ['label' => 'Dự án', 'url' => base_url('du-an.php')],
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo htmlspecialchars(base_url('assets/css/style.css?v=' . $styleVersion)); ?>">
</head>
<body class="<?php echo htmlspecialchars($bodyClass); ?>">
    <header class="site-header">
        ...
        <a class="employee-header-action" href="<?php echo htmlspecialchars($employeeAccessUrl); ?>" aria-label="<?php echo htmlspecialchars($employeeAccessLabel); ?>" title="<?php echo htmlspecialchars($employeeAccessLabel); ?>">
            <span class="employee-header-action-ring"></span>
            <span class="employee-header-action-core">
